import {Scene, Engine, FreeCamera, Vector3, HemisphericLight, MeshBuilder, SceneLoader, AbstractMesh, GlowLayer, LightGizmo, GizmoManager, Light, Color3, DirectionalLight, PointLight, SpotLight, ShadowGenerator} from "@babylonjs/core";
import "@babylonjs/loaders";

export default class LightsShadows {
  scene: Scene;
  engine: Engine;
